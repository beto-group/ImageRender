...
| **[src/index.jsx](src/index.jsx)** | Main bootstrapper/loader hook that resolves outer directories and coordinates imports. |
| **[src/App.jsx](src/App.jsx)** | The core coordinator view component that handles fuzzy searching, Lottie configurations, and loading indicators. |
...
| **[METADATA.md](METADATA.md)** | Machine-readable indexing manifest outlining component capabilities, type, and offline permissions. |
